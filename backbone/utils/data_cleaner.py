...
from backbone.openai import openAI_response as oa
from backbone.openai.openAI_response import get_response
...
def rename_company(df, column='company'):
    ...
    df[column] = df[column].str.replace(r'Cardinal Health Uk 434 Ltd.*', 'Cardinal Health Uk 434 Ltd', regex=True, flags=re.I)
    ...
    df[column] = df[column].str.replace(r'Jensonr.*', 'Jensonr + Ltd', regex=True, flags=re.I)
