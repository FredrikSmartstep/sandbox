...
CREATE TABLE IF NOT EXISTS `documents_db`.`PICO` (
  ...
  UNIQUE INDEX `unique_pico` (`population` ASC, `intervention` ASC, `comparator_company` ASC, `comparator_agency` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `documents_db`.`analysis` (
  ...
  `efficacy_summary` VARCHAR(300) NULL,
  `safety_summary` VARCHAR(300) NULL,
  `decision_summary` VARCHAR(300) NULL,
