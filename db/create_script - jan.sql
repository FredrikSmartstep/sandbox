...
-- Schema documents_db
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `documents_db` ;

-- -----------------------------------------------------
-- Schema documents_db
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `documents_db` DEFAULT CHARACTER SET utf8 COLLATE utf8_swedish_ci ;
USE `documents_db` ;

-- -----------------------------------------------------
-- Table `documents_db`.`company`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`company` (
...
-- -----------------------------------------------------
-- Table `documents_db`.`HTA_agency`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`HTA_agency` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `documents_db`.`HTA_document`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`HTA_document` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE INDEX `unique_date_diarie_document_type` (`diarie_nr` ASC, `date` ASC, `document_type` ASC) INVISIBLE,
  CONSTRAINT `fk_HTA_document_company`
    FOREIGN KEY (`idcompany`)
    REFERENCES `documents_db`.`company` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_HTA_document_HTA_agency1`
    FOREIGN KEY (`idHTA_agency`)
    REFERENCES `documents_db`.`HTA_agency` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `documents_db`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`product` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `name_UNIQUE` (`name` ASC) VISIBLE)
...
-- -----------------------------------------------------
-- Table `documents_db`.`HTA_document_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`HTA_document_product` (
  ...
  CONSTRAINT `fk_HTA_document_has_product_HTA_document1`
    ...
    REFERENCES `documents_db`.`HTA_document` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_HTA_document_has_product_product1`
    FOREIGN KEY (`idproduct`)
    REFERENCES `documents_db`.`product` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `documents_db`.`indication`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`indication` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `documents_db`.`product_has_indication`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`product_has_indication` (
  `idproduct` INT NOT NULL,
  ...
  CONSTRAINT `fk_product_has_indication_indication1`
    ...
    REFERENCES `documents_db`.`indication` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `documents_db`.`staff`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`staff` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `documents_db`.`HTA_document_staff`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`HTA_document_staff` (
  `idHTA_document` INT NOT NULL,
  ...
  UNIQUE INDEX `unique_staff_role` (`role` ASC, `idstaff` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_HTA_document_has_reviewer_reviewer1`
    FOREIGN KEY (`idstaff`)
    REFERENCES `documents_db`.`staff` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `documents_db`.`expert`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`expert` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `documents_db`.`HTA_document_has_expert`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`HTA_document_has_expert` (
  `idHTA_document` INT NOT NULL,
  ...
  CONSTRAINT `fk_HTA_document_has_expert_expert1`
    ...
    REFERENCES `documents_db`.`expert` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `documents_db`.`active_drug`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`active_drug` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `unique_ATC` (`ATC` ASC) VISIBLE)
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `documents_db`.`form`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`form` (
...
-- -----------------------------------------------------
-- Table `documents_db`.`price`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`price` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `varunummer` INT NULL,
  `ATC` VARCHAR(45) NULL,
  ...
  CONSTRAINT `fk_price_form1`
    FOREIGN KEY (`NPL_id`)
    REFERENCES `documents_db`.`form` (`NPL_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `documents_db`.`NT_council_recommendation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`NT_council_recommendation` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `date` DATE NULL,
  ...
  UNIQUE INDEX `unique_date_idproduct` (`date` ASC, `idproduct` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `documents_db`.`NT_council_deal`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`NT_council_deal` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `date` DATE NULL,
  `ATC` VARCHAR(45) NULL,
  `active_drug` VARCHAR(200) NULL,
...
-- -----------------------------------------------------
-- Table `documents_db`.`NT_council_follow_up`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`NT_council_follow_up` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `date` DATE NULL,
  `active_drug` VARCHAR(200) NULL,
  `indication` VARCHAR(200) NULL,
...
-- -----------------------------------------------------
-- Table `documents_db`.`EMA_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`EMA_status` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `documents_db`.`product_has_active_drug`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`product_has_active_drug` (
  `idproduct` INT NOT NULL,
  ...
  CONSTRAINT `fk_product_has_active_drug_active_drug1`
    ...
    REFERENCES `documents_db`.`active_drug` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `documents_db`.`regulatory_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`regulatory_status` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `idproduct` INT NOT NULL,
  `strength` VARCHAR(100) NULL,
  `form` VARCHAR(100) NULL,
  ...
  UNIQUE INDEX `unique_idproduct_country` (`idproduct` ASC, `country` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `documents_db`.`product_company`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`product_company` (
  `idcompany` INT NOT NULL,
  `idproduct` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `documents_db`.`HTA_document_indication`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`HTA_document_indication` (
  `idHTA_document` INT NOT NULL,
  `idindication` INT NOT NULL,
  ...
  UNIQUE INDEX `unique_hta_indication_severity` (`idHTA_document` ASC, `idindication` ASC, `severity` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `documents_db`.`demographics`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`demographics` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `pediatric` TINYINT(1) NULL,
  `adolescent` TINYINT(1) NULL,
  `adult` TINYINT(1) NULL,
  `elderly` TINYINT(1) NULL,
  `gender` VARCHAR(45) NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `unique` (`pediatric` ASC, `adolescent` ASC, `adult` ASC, `elderly` ASC, `gender` ASC) VISIBLE)
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `documents_db`.`population`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`population` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `description` VARCHAR(300) NULL,
  `genetic_factors` VARCHAR(100) NULL,
  `family_history` TINYINT(1) NULL,
  `sub_diagnosis` VARCHAR(100) NULL,
  `disease_stage` VARCHAR(45) NULL,
  `biomarker_status` VARCHAR(100) NULL,
  `co_morbidities` VARCHAR(100) NULL,
  `previous_treatment` VARCHAR(100) NULL,
  `response_to_treatment` VARCHAR(100) NULL,
  `lifestyle_factors` VARCHAR(100) NULL,
  `psychosocial_factors` VARCHAR(100) NULL,
  `special_conditions` VARCHAR(100) NULL,
  `idindication` INT NOT NULL,
  `id_demographics` INT NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `unique` (`genetic_factors` ASC, `family_history` ASC, `sub_diagnosis` ASC, `disease_stage` ASC, `biomarker_status` ASC, `co_morbidities` ASC, `previous_treatment` ASC, `response_to_treatment` ASC, `lifestyle_factors` ASC, `psychosocial_factors` ASC, `special_conditions` ASC, `idindication` ASC) VISIBLE,
  INDEX `fk_population_indication1_idx` (`idindication` ASC) VISIBLE,
  INDEX `fk_population_demographics1_idx` (`id_demographics` ASC) VISIBLE,
  CONSTRAINT `fk_population_indication1`
    FOREIGN KEY (`idindication`)
    REFERENCES `documents_db`.`indication` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_population_demographics1`
    FOREIGN KEY (`id_demographics`)
    REFERENCES `documents_db`.`demographics` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `documents_db`.`PICO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`PICO` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `idHTA_document` INT NULL,
  `population` VARCHAR(300) NULL,
  ...
  `comparator_company` VARCHAR(200) NULL,
  `comparator_agency` VARCHAR(200) NULL,
  `comparator_reason_company` VARCHAR(250) NULL,
  `comparator_reason_agency` VARCHAR(250) NULL,
  `comparator_modus_company` VARCHAR(150) NULL,
  `comparator_modus_agency` VARCHAR(150) NULL,
  `outcome_measure_company` VARCHAR(200) NULL,
  `outcome_measure_agency` VARCHAR(200) NULL,
  `idproduct` INT NOT NULL,
  `idindication` INT NOT NULL,
  ...
  UNIQUE INDEX `unique_pico` (`population` ASC, `intervention` ASC, `comparator_company` ASC, `comparator_agency` ASC, `idindication` ASC, `idpopulation` ASC) VISIBLE,
  INDEX `fk_PICO_population1_idx` (`idpopulation` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_PICO_indication1`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_PICO_population1`
    FOREIGN KEY (`idpopulation`)
    REFERENCES `documents_db`.`population` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `documents_db`.`analysis`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`analysis` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `idPICO` INT NOT NULL,
  ...
  `efficacy_summary` VARCHAR(500) NULL,
  `safety_summary` VARCHAR(500) NULL,
  ...
  UNIQUE INDEX `idPICO_UNIQUE` (`idPICO` ASC) VISIBLE,
  CONSTRAINT `fk_analysis_PICO1`
    FOREIGN KEY (`idPICO`)
    REFERENCES `documents_db`.`PICO` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `documents_db`.`trial`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`trial` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  `primary_outcome_variable` VARCHAR(45) NULL,
  ...
  CONSTRAINT `fk_trial_analysis1`
    ...
    REFERENCES `documents_db`.`analysis` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `documents_db`.`Costs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`Costs` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `assessor` VARCHAR(45) NULL,
  `idanalysis` INT NOT NULL,
  `drug_cost` VARCHAR(100) NULL,
  `other_costs` VARCHAR(100) NULL,
  `total_treatment_cost` VARCHAR(100) NULL,
  `product` VARCHAR(45) NULL,
  `cost_type` VARCHAR(45) NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Costs_analysis1_idx` (`idanalysis` ASC) VISIBLE,
  UNIQUE INDEX `unique_analysis_assessor_product` (`idanalysis` ASC, `assessor` ASC, `product` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `documents_db`.`EMA_atmp_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`EMA_atmp_status` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `idproduct` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `documents_db`.`outcome_measure`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`outcome_measure` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `documents_db`.`outcome_value`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `documents_db`.`outcome_value` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `trial_arm` VARCHAR(45) NULL,
  `value` VARCHAR(45) NULL,
  `significance_level` VARCHAR(45) NULL,
  `idoutcome_measure` INT NOT NULL,
  `idtrial` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_outcome_value_outcome_measure1_idx` (`idoutcome_measure` ASC) VISIBLE,
  INDEX `fk_outcome_value_trial1_idx` (`idtrial` ASC) VISIBLE,
  CONSTRAINT `fk_outcome_value_outcome_measure1`
    FOREIGN KEY (`idoutcome_measure`)
    REFERENCES `documents_db`.`outcome_measure` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_outcome_value_trial1`
    FOREIGN KEY (`idtrial`)
    REFERENCES `documents_db`.`trial` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
